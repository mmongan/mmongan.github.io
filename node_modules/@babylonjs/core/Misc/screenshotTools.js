 ...
 */
export function CreateScreenshot(engine, camera, size, successCallback, mimeType = "image/png", forceDownload = false, quality, useFill = false) {
 ...
 */
export async function CreateScreenshotAsync(engine, camera, size, mimeType = "image/png", quality, useFill = false) {
    return new Promise((resolve, reject) => {
        ...
        }, mimeType, undefined, quality, useFill);
    });
}
/**
        ...
        _RetryWithInterval(() => texture.isReadyForRendering() && camera.isReady(true), () => {
            engine.onEndFrameObservable.addOnce(() => {
                if (finalWidth === width && finalHeight === height) {
                    ...
                    importPromise.then(async () => ApplyPostProcess("pass", texture.getInternalTexture(), scene, undefined, undefined, undefined, finalWidth, finalHeight).then((texture) => {
