...
var WebXRAbstractFeature = class {
  ...
  set xrNativeFeatureName(name) {
    var _a;
    if (!this._xrSessionManager.isNative && name && this._xrSessionManager.inXRSession && ((_a = this._xrSessionManager.enabledFeatures) == null ? void 0 : _a.indexOf(name)) === -1) {
...
//# sourceMappingURL=chunk-KCICUKZ4.js.map
