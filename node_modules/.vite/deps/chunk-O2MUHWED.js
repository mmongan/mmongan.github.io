...
var _TmpMorphInfluencers = { NUM_MORPH_INFLUENCERS: 0 };
...
var Material = class _Material {
   ...
   */
  constructor(name16, scene, doNotAdd) {
    ...
    this._uniformBuffer = new UniformBuffer(this._scene.getEngine(), void 0, void 0, name16);
...
var PushMaterial = class extends Material {
  constructor(name16, scene, storeEffectOnSubMeshes = true) {
    super(name16, scene);
...
var Texture = class _Texture extends BaseTexture {
   ...
   * @internal
   */
  static _CreateVideoTexture(name16, src, scene, generateMipMaps = false, invertY = false, samplingMode = _Texture.TRILINEAR_SAMPLINGMODE, settings = {}, onError, format = 5) {
   ...
   */
  static CreateFromBase64String(data, name16, scene, noMipmapOrOptions, invertY, samplingMode = _Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags) {
    return new _Texture("data:" + name16, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, data, false, format, void 0, void 0, creationFlags);
  }
  /**
   ...
   * @returns the created texture
   */
  static LoadFromDataString(name16, buffer, scene, deleteBuffer = false, noMipmapOrOptions, invertY = true, samplingMode = _Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags) {
    if (name16.substr(0, 5) !== "data:") {
      name16 = "data:" + name16;
    }
    return new _Texture(name16, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, buffer, deleteBuffer, format, void 0, void 0, creationFlags);
  }
};
...
Texture._CreateMirror = (name16, renderTargetSize, scene, generateMipMaps) => {
  throw _WarnImport("MirrorTexture");
};
Texture._CreateRenderTargetTexture = (name16, renderTargetSize, scene, generateMipMaps, creationFlags) => {
...
var name5 = "bonesDeclaration";
var shader5 = `#if NUM_BONE_INFLUENCERS>0
...
var name6 = "bakedVertexAnimationDeclaration";
...
var name7 = "instancesDeclaration";
var shader7 = `#ifdef INSTANCES
...
var name11 = "bonesVertex";
var shader11 = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
var name12 = "bakedVertexAnimation";
var shader12 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
var name14 = "fogVertex";
var shader14 = `#ifdef FOG
...
var name15 = "vertexColorMixing";
var shader15 = `#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=color;
...
//# sourceMappingURL=chunk-O2MUHWED.js.map
