...
var MaterialDefines = class {
  ...
  rebuild() {
    ...
    if (this._externalProperties) {
      for (const name49 in this._externalProperties) {
        if (this._keys.indexOf(name49) === -1) {
          this._keys.push(name49);
        }
      }
    }
  }
...
var name21 = "logDepthDeclaration";
...
var name22 = "bumpFragment";
var shader22 = `vec2 uvOffset=vec2(0.0,0.0);
...
var name23 = "decalFragment";
var shader23 = `#ifdef DECAL
#ifdef GAMMADECAL
...
var name24 = "depthPrePass";
var shader24 = `#ifdef DEPTHPREPASS
...
var name25 = "lightFragment";
var shader25 = `#ifdef LIGHT{X}
...
var name35 = "lightVxFragmentDeclaration";
var shader35 = `#ifdef LIGHT{X}
uniform vec4 vLightData{X};uniform vec4 vLightDiffuse{X};
#ifdef SPECULARTERM
uniform vec4 vLightSpecular{X};
#else
...
var name36 = "lightVxUboDeclaration";
...
var name37 = "morphTargetsVertexGlobalDeclaration";
var shader37 = `#ifdef MORPHTARGETS
...
var name38 = "morphTargetsVertexDeclaration";
var shader38 = `#ifdef MORPHTARGETS
...
var name39 = "morphTargetsVertexGlobal";
var shader39 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
...
var name40 = "morphTargetsVertex";
var shader40 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
var name41 = "prePassVertex";
var shader41 = `#ifdef PREPASS_DEPTH
...
var name42 = "uvVariableDeclaration";
var shader42 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var name43 = "samplerVertexImplementation";
var shader43 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
var name44 = "bumpVertex";
var shader44 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
var name45 = "shadowsVertex";
var shader45 = `#ifdef SHADOWS
...
var name46 = "pointCloudVertex";
var shader46 = `#if defined(POINTSIZE) && !defined(WEBGPU)
...
var name47 = "logDepthVertex";
var shader47 = `#ifdef LOGARITHMICDEPTH
...
var name48 = "defaultVertexShader";
var shader48 = `#include<__decl__defaultVertex>
...
var MaterialPluginManager = class _MaterialPluginManager {
  ...
  getPlugin(name49) {
    for (let i = 0; i < this._plugins.length; ++i) {
      if (this._plugins[i].name === name49) {
...
function RegisterMaterialPlugin(pluginName, factory) {
  ...
  const existing = plugins.filter(([name49, _factory]) => name49 === pluginName);
...
var MaterialPluginBase = class {
   ...
   */
  constructor(material, name49, priority, defines, addToPluginList = true, enable = false, resolveIncludes = false) {
    this.priority = 500;
...
var StandardMaterial = class _StandardMaterial extends PushMaterial {
   ...
   */
  clone(name49, cloneTexturesOnlyOnce = true, rootUrl = "") {
    const result = SerializationHelper.Clone(() => new _StandardMaterial(name49, this.getScene()), this, { cloneTexturesOnlyOnce });
    result.name = name49;
    result.id = name49;
...
//# sourceMappingURL=chunk-XDF2MLCS.js.map
