import{S as e}from"./index-BqJGTxyM.js";import"./logDepthDeclaration-BoNtg_9O.js";import"./helperFunctions-D7Ud2dLU.js";import"./imageProcessingFunctions-C5B7ClJa.js";import"./clipPlaneFragment-Cz023J6V.js";import"./fogFragment-B6g1KdJi.js";const o="decalFragmentDeclaration",L=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=L);const t="defaultFragmentDeclaration",A=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const a="prePassDeclaration",I=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=I);const r="oitDeclaration",T=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=T);const n="lightFragmentDeclaration",P=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=P);const f="lightUboDeclaration",X=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=x);const s="lightsFragmentFunctions",F=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=F);const d="shadowsFragmentFunctions",R=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=R);const c="samplerFragmentDeclaration",N=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=N);const h="fresnelFunction",M=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=M);const v="reflectionFunction",O=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=O);const u="bumpFragmentMainFunctions",y=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=y);const p="bumpFragmentFunctions",_=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=_);const m="bumpFragment",b=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=b);const S="decalFragment",U=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=U);const g="depthPrePass",W=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=W);const E="lightFragment",z=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=z);const C="logDepthFragment",H=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=H);const D="oitFragment",V=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=V);const i="defaultPixelShader",w=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=w);const q={name:i,shader:w};export{q as defaultPixelShader};
