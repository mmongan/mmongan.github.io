import{S as e}from"./index-BqJGTxyM.js";const o="sceneUboDeclaration",n=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;};
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);const i="meshUboDeclaration",c=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=c);const t="defaultUboDeclaration",s=`layout(std140,column_major) uniform;uniform Material
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=s);const a="mainUVVaryingDeclaration",f=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=f);const r="logDepthDeclaration",l=`#ifdef LOGARITHMICDEPTH
